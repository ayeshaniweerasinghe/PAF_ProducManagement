...
function validateProductForm() {
 ...
 // manufacture----------------------------------
    if ($("#productManu").val().trim() == "") {
        return "Insert Product Manufacture.";
    }
    // price-------------------------------
...
$(document).on("click", ".btnUpdate", function (event) 
{
    	...
    	$("#productDesc").val($(this).closest("tr").find('td:eq(1)').text());
    	$("#productManu").val($(this).closest("tr").find('td:eq(2)').text());
